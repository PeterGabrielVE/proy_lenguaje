                         ...
                         <div class="row">
                            <div class="col-md-12">
                                <div class="card card-filter">
                                     @include('customers_views/customers_navigation_horizontal')
                                    ...
                                    <div class="card-block">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-xs-12">
                                                <div class="flt1a">
                                                    <a class="btn btn-default" href="{{url('/customers/page/')}}{{$get_previous_page_number}}"> <i class="fa fa-arrow-left"></i> Previous</a>
                                                    <span>
                                                        Page
                                                    ...
                                                    <a class="btn btn-default" 
                                                        href="{{url('/customers/page')}}/{{$get_next_page_number}}">
